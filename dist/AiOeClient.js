...
var AiOeClient = /*#__PURE__*/function () {
  ...
  return _createClass(AiOeClient, [{
    ...
    value: (function () {
      ...
      function testPushNotification(_x) {
    ...
    value: function () {
      ...
      function pushNotificationToken(_x2, _x3, _x4, _x5, _x6) {
    ...
    value: function () {
      ...
      function updatePassword(_x0, _x1, _x10) {
    ...
    value: function () {
      ...
      function updateGroupAccess(_x14, _x15, _x16) {
    ...
    value: (function () {
      ...
      function command(_x17, _x18, _x19) {
    ...
    value: function () {
      var _post = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee0(message, apiKey) {
        var content, formData, attachment, uri, type, uriParts, fileType, tb, _uriParts, _fileType, response;
          ...
          while (1) switch (_context0.prev = _context0.next) {
            case 0:
              ...
              if (message.attachments.length) {
                ...
                if (type === 'string') {
                  uriParts = uri.split('.');
                  fileType = uriParts[uriParts.length - 1]; // If you have a File or Blob, use it directly. If not, append the URI string.
                ...
                if (attachment.thumbnail_uri) {
                  tb = attachment.thumbnail_uri;
                  if (type === 'string') {
                    _uriParts = tb.split('.');
                    _fileType = _uriParts[_uriParts.length - 1]; // If you have a File or Blob, use it directly. If not, append the URI string.
              ...
              _context0.next = 9;
              return this.fetch(this.API_URL + '/api/chat', {
                method: 'POST',
                headers: {
                  'x-api-key': apiKey
                },
    ...
    value: function () {
      ...
      function postReceipt(_x22, _x23, _x24) {
    ...
    value: function () {
      ...
      function callApi(_x28, _x29, _x30) {
    ...
    value: function () {
      ...
      function deleteEntity(_x35, _x36, _x37) {
    ...
    key: "fetch",
    value: function () {
      var _fetch2 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee17(uri, params) {
        var response, errorData, json;
        return _regeneratorRuntime().wrap(function _callee17$(_context17) {
          while (1) switch (_context17.prev = _context17.next) {
            case 0:
              _context17.next = 2;
              return _fetch(uri, params);
            case 2:
